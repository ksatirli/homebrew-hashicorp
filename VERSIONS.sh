...
CONSUL_16X=("1.6.0-beta1" "1.6.0-beta2" "1.6.0-beta3" "1.6.0-rc1" "1.6.0" "1.6.0+ent-rc1" "1.6.0+ent-beta3" "1.6.0+ent-beta1" "1.6.0+ent" "1.6.0+ent-beta2" "1.6.1" "1.6.1+ent" "1.6.2" "1.6.2+ent" "1.6.3" "1.6.3+ent" "1.6.4" "1.6.4+ent" "1.6.5" "1.6.5+ent" "1.6.6" "1.6.6+ent" "1.6.7" "1.6.7+ent" "1.6.8" "1.6.8+ent")

# released between 2020-02 and 2020-05
CONSUL_17X=("1.7.0-beta1" "1.7.0-beta2" "1.7.0-beta3" "1.7.0-beta4" "1.7.0" "1.7.0+ent-beta2" "1.7.0+ent-beta1" "1.7.0+ent-beta3" "1.7.0+ent" "1.7.0+ent-beta4" "1.7.1" "1.7.1+ent" "1.7.2" "1.7.2+ent" "1.7.3" "1.7.3+ent" "1.7.4" "1.7.4+ent" "1.7.5" "1.7.5+ent" "1.7.6" "1.7.6+ent" "1.7.7" "1.7.7+ent")

# released between 2020-05 and
CONSUL_18X=("1.8.0-beta1" "1.8.0+ent-beta1" "1.8.0-beta2" "1.8.0+ent-beta2" "1.8.0-rc1" "1.8.0+ent-rc1" "1.8.0" "1.8.0+ent" "1.8.1" "1.8.1+ent" "1.8.2" "1.8.2+ent" "1.8.3" "1.8.3+ent")
...
SENTINEL_015X=("0.15.0" "0.15.1" "0.15.2" "0.15.3" "0.15.4" "0.15.5" "0.15.6")
...
VAGRANT_22X=("2.2.0" "2.2.1" "2.2.2" "2.2.3" "2.2.4" "2.2.5" "2.2.6" "2.2.7" "2.2.8" "2.2.9" "2.2.10")
